(() => {
  ...
  // extensions/validation-ui-extension/src/ValidationSettings.jsx
  ...
  var TARGET = "admin.settings.validation.render";
  var METAFIELD_NAMESPACE = "$app:cart-validation";
  var METAFIELD_KEY = "minimum-order-threshold";
  var ValidationSettings_default = reactExtension(TARGET, (api) => __async(void 0, null, function* () {
    console.log("Extension context:", api.data);
    const currentValue = yield getCurrentMetafieldValue(api.query);
    ...
    const initialThreshold = currentValue ? parseFloat(currentValue) : 1e3;
    console.log("Initial threshold:", initialThreshold);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ValidationSettings, { initialThreshold });
  }));
  function getCurrentMetafieldValue(adminApiQuery) {
    return __async(this, null, function* () {
      var _a, _b, _c, _d, _e;
      const query = `#graphql
  ...
  `;
      ...
      const value = (_e = (_d = (_c = (_b = (_a = result == null ? void 0 : result.data) == null ? void 0 : _a.metafieldDefinitions) == null ? void 0 : _b.nodes[0]) == null ? void 0 : _c.metafields) == null ? void 0 : _d.nodes[0]) == null ? void 0 : _e.value;
      if (value) {
  ...
  function ValidationSettings({ initialThreshold }) {
    ...
    const [threshold, setThreshold] = (0, import_react16.useState)(initialThreshold);
    ...
    return (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(FunctionSettings2, { onError, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ErrorBanner, { errors }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Section2, { heading: "Minimum Order Threshold Settings", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { paddingBlock: "large", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { minInlineSize: "50%", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Set the minimum order total required to proceed with checkout" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { minInlineSize: "50%", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            NumberField2,
            {
              value: threshold,
              min: 0,
  ...
  function ErrorBanner({ errors }) {
    if (errors.length === 0)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { paddingBlockEnd: "large", children: errors.map((error, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "Errors were encountered", tone: "critical", children: error }, i)) });
  }
  ...
  function createMetafieldDefinition(adminApiQuery) {
    return __async(this, null, function* () {
      ...
      const definition = {
        ...
        // Using single_line_text_field for direct string storage
      };
      const query = `#graphql
...
//# sourceMappingURL=validation-ui-extension.js.map
